...
const Dashboard = (props) => {
	...
	const widgets = useSelector(({ Dashboard }) => Dashboard.widgets);
	const projects = useSelector(({ Dashboard }) => Dashboard.projects);
	const nameUser = useSelector(({ auth }) => auth.user.data.displayName);
